    ...
    try {
      ...
      if (UserId != null) {
        ...
        if (res.statusCode == 200) {
          ...
          var jsonData =
              json.decode(res.body); // This will be a Map<String, dynamic>
          // print(jsonData);
          ...
          if (notesData != null && notesData is List) {
            ...
            List<FetchNotes> notes = notesData
                ...
                .map<FetchNotes>(
                    (note) => FetchNotes.fromMap(note as Map<String, dynamic>))
                .toList();
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
                  content: Text("No notes found in the frontend server side")),
            );
            return [];
          }
        } else {
          ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text("Notes are not fetched")));
        }
      }
    } catch (e) {
      print(e);
